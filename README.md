...
ansible-playbook tags.yml --start-at-task "start NTP service" (usando tags voce pode escolher uma determinada task).
ansible-playbook tags.yml --step (pergunta em cada tasks se voce pretende seguir).
```